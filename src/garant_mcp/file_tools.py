...
def save_to_case(
    content: str, case_path: str, filename: str, subfolder: str = "служебное для агента"
) -> str:
...
def copy_docx_to_case(
    source_path: str, case_path: str, new_filename: Optional[str] = None
) -> str:
