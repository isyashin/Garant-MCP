...
class TestFileTools:
    ...
    def test_save_to_case(self):
        ...
        filepath1 = save_to_case("Test content 1", case_path, "test1.txt", "исходные данные")
        filepath2 = save_to_case("Test content 2", case_path, "test2.txt", "результат")
        filepath3 = save_to_case("Test content 3", case_path, "test3.txt", "служебное для агента")
